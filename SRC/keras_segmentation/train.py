...
def train(model,
    ...
    if do_augment:
        print("Image datasets will be augmented!")
    else:
        print("Image datasets won't be augmented!")
    ...
    class MyModelCheckpoint(ModelCheckpoint):
        ...
        def on_epoch_end(self, epoch, logs=None):
            model.save_weights(checkpoints_path + "_weights_" + str(epoch+1))
            model.save(checkpoints_path + "_model_" + str(epoch+1) + '.h5')
    ...
    if not validate:
        ...
        model.fit_generator(train_gen, steps_per_epoch, epochs=epochs, callbacks=[tensorboard_callback, checkpointer])
        # if checkpoints_path is not None:
        #     model.save_weights(checkpoints_path + "_model_" + str(ep))
        #     print("saved ", checkpoints_path + "_model_" + str(ep))
        ...
        model.fit_generator(train_gen, steps_per_epoch,
                            ...
                            validation_steps=200,  epochs=epochs, callbacks=[tensorboard_callback, checkpointer])
        # if checkpoints_path is not None:
        #     model.save_weights(checkpoints_path + "_model_" + str(ep))
        #     print("saved ", checkpoints_path + "_model_" + str(ep))
        # print("Finished Epoch", ep)
